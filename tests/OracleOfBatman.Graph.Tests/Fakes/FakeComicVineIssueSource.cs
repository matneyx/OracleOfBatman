...
/// <summary>
///   In-memory IComicVineIssueSource backed by a hand-built issue map, so
///   ConnectionCrawler tests don't depend on real HTTP.
/// </summary>
public sealed class FakeComicVineIssueSource(
  Dictionary<int, ComicVineIssue> issues,
  IReadOnlySet<int>? failingIds = null) : IComicVineIssueSource
{
