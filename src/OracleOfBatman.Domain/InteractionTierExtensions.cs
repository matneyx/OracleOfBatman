...
{
  /// <summary>
  ///   A single past-tense verb fitting "{Character} was {phrase} in {issue} with
  ///   {other Character}" (the human-readable hop sentence).
  /// </summary>
  ...
  /// <summary>
  ///   Whether this tier's meaning is the same regardless of which Character is
  ...
  ///   produces two relationships pointing opposite ways.
  /// </summary>
