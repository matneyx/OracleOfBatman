...
public interface IGraphStore
{
  ...
  /// <summary>
  ///   Every other Character anywhere in the graph sharing at least one issue with
  ///   the given list, keyed by their Comic Vine id, with which issue(s) matched.
  /// </summary>
  Task<IReadOnlyDictionary<int, IReadOnlyList<int>>> FindOverlappingIssuesAsync(int comicVineId,
