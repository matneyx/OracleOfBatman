...
/// <summary>The series an issue belongs to. Collected-edition issues (TPBs, omnibuses) often
/// have a blank or generic "TPB" issue name — the Volume's name (the series title) is the only
/// identifying info Comic Vine gives for those.</summary>
...
/// <summary>A /search/?resources=character result. Comic Vine's search is full-text across
/// bio/description too, not a pure name match — expect some tangentially-related results.</summary>
