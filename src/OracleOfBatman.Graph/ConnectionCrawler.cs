...
public sealed class ConnectionCrawler(
  ...
  IComicVineIssueSource issueSource,
  IGraphStore graphStore)
{
  ...
  /// <summary>
  ///   Enriches the issue name with its Volume (series) name when the issue's own name
  ...
  ///   often bridges several overlapping characters.
  /// </summary>
