...
if (comicVineApiKey is not null)
{
    ...
    builder.Services.AddScoped(sp =>
    {
        ...
        return new ComicVineApiClient(httpClient, comicVineApiKey);
    });
    ...
    builder.Services.AddScoped(sp => new ConnectionCrawler(sp.GetRequiredService<IComicVineCharacterSource>(), sp.GetRequiredService<IComicVineIssueSource>(), sp.GetRequiredService<IGraphStore>()));
}
